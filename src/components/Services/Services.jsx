...
const Services = () => {
  return <div className="container my-16 space-y-4">
    ...
    <div className="text-center max-w-lg mx-auto space-y-2">
      ...
      <p className="text-sm opacity-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam fuga inventore, quia officiis molestias quo. Aliquid non est dolorum dolorem!</p>
    </div>
    {/* card section */}
